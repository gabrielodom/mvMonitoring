...
#' under normal operating conditions and observations after a dampening of one
#' of the underlying features in the system.
#'
...
#' dampening in the underlying determining t vector for the "z" feature. The
