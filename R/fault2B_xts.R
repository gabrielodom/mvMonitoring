...
#'   positive drift in values for two features.
#'
...
#'   fault is a drift on the "y" and "z" features by s / 10 ^ 3, where s is the
#'   observation index. The fault starts at row 8500, and the four columns under
#'   the fault state are defined here:
#' \itemize{
