...
##   Data: num [1:4142, 1:5] 0.2109 0.0632 0.4924 0.7234 0.6277 ...
##  - attr(*, "dimnames")=List of 2
##   ..$ : NULL
...
##   Data: num [1:4141, 1:7] 2 3 1 1 1 1 1 1 1 1 ...
##  - attr(*, "dimnames")=List of 2
##   ..$ : NULL
##   ..$ : chr [1:7] "state" "x" "y" "z" ...
##   Indexed by objects of class: [POSIXct,POSIXt] TZ: 
##   xts Attributes:  
##  NULL
##  $ Alarms         :An 'xts' object on 2015-05-19 13:13:00/2015-05-19 13:13:00 containing:
##   Data: num [1, 1:11] 1.81 -2.32 4.2 2.07 -2.11 ...
##  - attr(*, "dimnames")=List of 2
##   ..$ : NULL
##   ..$ : chr [1:11] "x" "y" "z" "x.1" ...
##   Indexed by objects of class: [POSIXct,POSIXt] TZ: 
...
##   ..$ 1:List of 6
##   .. ..$ SPE_threshold   : Named num 4.71
##   .. .. ..- attr(*, "names")= chr "99.9%"
##   .. ..$ T2_threshold    : Named num 60.5
##   .. .. ..- attr(*, "names")= chr "99.9%"
##   .. ..$ projectionMatrix: num [1:6, 1:2] 0.423 -0.382 0.437 0.431 -0.315 ...
##   .. ..$ LambdaInv       : num [1:2, 1:2] 0.205 0 0 1.579
##   .. ..$ muTrain         : Named num [1:6] 1.37 -2.1 2.95 1.36 -2.06 ...
##   .. .. ..- attr(*, "names")= chr [1:6] "x" "y" "z" "x.1" ...
##   .. ..$ RootPrecisTrain : num [1:6, 1:6] 2.6 0 0 0 0 ...
##   .. ..- attr(*, "class")= chr [1:2] "threshold" "pca"
##   ..$ 2:List of 6
##   .. ..$ SPE_threshold   : Named num 1.14
##   .. .. ..- attr(*, "names")= chr "99.9%"
##   .. ..$ T2_threshold    : Named num 76.8
##   .. .. ..- attr(*, "names")= chr "99.9%"
##   .. ..$ projectionMatrix: num [1:6, 1:3] -0.496 -0.065 0.49 -0.523 -0.183 ...
##   .. ..$ LambdaInv       : num [1:3, 1:3] 0.283 0 0 0 0.735 ...
##   .. ..$ muTrain         : Named num [1:6] 2.979 -0.564 -4.508 2.952 -0.589 ...
##   .. .. ..- attr(*, "names")= chr [1:6] "x" "y" "z" "x.1" ...
##   .. ..$ RootPrecisTrain : num [1:6, 1:6] 1.06 0 0 0 0 ...
##   .. ..- attr(*, "class")= chr [1:2] "threshold" "pca"
##   ..$ 3:List of 6
##   .. ..$ SPE_threshold   : Named num 7.2
##   .. .. ..- attr(*, "names")= chr "99.9%"
##   .. ..$ T2_threshold    : Named num 82.7
##   .. .. ..- attr(*, "names")= chr "99.9%"
##   .. ..$ projectionMatrix: num [1:6, 1:2] -0.393 -0.451 -0.455 0.16 -0.464 ...
##   .. ..$ LambdaInv       : num [1:2, 1:2] 0.278 0 0 0.494
##   .. ..$ muTrain         : Named num [1:6] 0.528 0.27 1.423 0.569 0.256 ...
##   .. .. ..- attr(*, "names")= chr [1:6] "x" "y" "z" "x.1" ...
##   .. ..$ RootPrecisTrain : num [1:6, 1:6] 16.9 0 0 0 0 ...
##   .. ..- attr(*, "class")= chr [1:2] "threshold" "pca"
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##                     state         x         y         z       x.1
## 2015-05-22 07:00:00     1 0.6844440 -1.565320 1.1324768 0.3534816
## 2015-05-22 07:01:00     1 0.5454614 -1.369986 0.9184724 0.6844440
## 2015-05-22 07:02:00     1 0.6468377 -1.593779 0.8900444 0.5454614
## 2015-05-22 07:03:00     1 0.3543316 -1.361402 0.7855688 0.6468377
## 2015-05-22 07:04:00     1 0.3831960 -1.455579 0.6319864 0.3543316
## 2015-05-22 07:05:00     1 0.5734844 -1.406738 0.9210589 0.3831960
##                             y.1       z.1
## 2015-05-22 07:00:00  0.08705337 0.4466149
## 2015-05-22 07:01:00 -1.56532037 1.1324768
## 2015-05-22 07:02:00 -1.36998580 0.9184724
## 2015-05-22 07:03:00 -1.59377911 0.8900444
## 2015-05-22 07:04:00 -1.36140249 0.7855688
## 2015-05-22 07:05:00 -1.45557880 0.6319864
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##                             x         y         z       x.1         y.1
## 2015-05-22 07:00:00 0.6844440 -1.565320 1.1324768 0.3534816  0.08705337
## 2015-05-22 07:01:00 0.5454614 -1.369986 0.9184724 0.6844440 -1.56532037
## 2015-05-22 07:02:00 0.6468377 -1.593779 0.8900444 0.5454614 -1.36998580
## 2015-05-22 07:03:00 0.3543316 -1.361402 0.7855688 0.6468377 -1.59377911
## 2015-05-22 07:04:00 0.3831960 -1.455579 0.6319864 0.3543316 -1.36140249
## 2015-05-22 07:05:00 0.5734844 -1.406738 0.9210589 0.3831960 -1.45557880
##                           z.1       SPE SPE_Flag        T2 T2_Flag Alarm
## 2015-05-22 07:00:00 0.4466149 0.2948716        0 28.028452       0    NA
## 2015-05-22 07:01:00 1.1324768 0.9816014        0  5.025385       0    NA
## 2015-05-22 07:02:00 0.9184724 0.0316290        0  4.773963       0    NA
## 2015-05-22 07:03:00 0.8900444 0.8505646        0  6.333569       0    NA
## 2015-05-22 07:04:00 0.7855688 0.2234181        0  6.613971       0    NA
## 2015-05-22 07:05:00 0.6319864 0.4523686        0  5.922610       0    NA
\end{verbatim}
\end{kframe}
\end{knitrout}
