...
Now we can create data for our other two states. These states will be scaled rotations of the current $<x,y,z>$ set. Thus, we need the `rot_and_scale3d()` function from the `Rotation_Playground.R` file.
