...
## Examples
These are the examples shown in the help files for the mspTrain(), mspMonitor(), and mspWarning() functions.
```{r mspExamples}
normal_switch_xts <- mspProcessData(faults = "NOC", faultStartIndex = 8500)
