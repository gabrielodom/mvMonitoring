...
msadResults5_ls <- parLapply(cl = cl, 1:100, function(void){
# msadResults2_ls <- mclapply(1:1000, mc.cores = 8L, function(void){
  
  ##########   Draw a Random Data Set   ##########
  msadpcaObs_ls <- mspProcessData(faults = c("NOC", "C1", "C2", "C3"), # "All"
                              faultStartIndex = 8500,
                              startTime = "2016-11-27 00:00:00 CST",
                              multiState = TRUE,
                              adpcaTest = TRUE)
