...
write_csv(FA_rates2, path = "false_alarm_rates_1000_20170314.csv")
detectionTimes2 <- lapply(1:length(msadResults2_ls), function(i){
  msadResults2_ls[[i]]$time2Detect
}) %>% do.call(bind_rows, .)
write_csv(detectionTimes2, path = "detection_times_1000_20170314.csv")
```
...
FA_rates2[,2] %>% hist(xlim = c(0, 0.05), main = "MSAD T2 False Alarm Rates")
FA_rates2[,3] %>% hist(xlim = c(0, 0.05), main = "AD SPE False Alarm Rates")
