...
# doesn't work.
a <- Sys.time()
msadResults2_ls <- lapply(1:5, function(void){
...
# write_csv(FA_rates, path = "false_alarm_rates_20170314.csv")
detectionTimes2 <- lapply(1:length(msadResults2_ls), function(i){
  msadResults2_ls[[i]]$time2Detect
}) %>% do.call(bind_rows, .)
# write_csv(detectionTimes, path = "detection_times_20170314.csv")
```
